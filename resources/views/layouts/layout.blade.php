        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 col-md-3 item">
                    <h3>About</h3>
                    <ul>
                        <li><a href="https://github.com/tushar-hub/Backend-Project">GitHub</a></li>
                        <li><a href="https://github.com/tushar-hub/Backend-Project">Project</a></li>
                        <li></li>
                    </ul>
                </div>
            ...
            <p class="copyright">Tushar Kasana © 2021</p>
        </div>
    </footer>
